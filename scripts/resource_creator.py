...
class ResourceBlocking:
    ...
    def dev_info_hanlder(self, active_developer):
        ...
        seniority_option_id = get_cf_option_id(self.resource_cfs, "006faef7-4e5a-41c7-8b54-a8ed2665bb70", seniority)
        ...
        direction_option_id = get_cf_option_id(self.resource_cfs, "baf5146f-534c-44e0-9b9d-f84329154369", direction)
        ...
        title_option_id = get_cf_option_id(self.resource_cfs, "33cc9332-2bda-43e3-97fc-1131c8a0d5ee", title)
        if title_option_id:
        ...
        if not resource:
            resource = clickup_create_task("901204930768", clickup_resource_data)
        ...
        blocking = clickup_create_task("901204980269", clickup_blocking_data)
        self.month_blocks.append(blocking)
        blocking_id = blocking['id']
        return blocking_id

    def launcher(self):
        self.resource_cfs = get_list_custom_fields("901204930768")
        self.block_cfs = get_list_custom_fields("901204980269")
